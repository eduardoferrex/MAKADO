...
export default function FinalCTA() {
  ...
  return (
    ...
    >
      {/* Background soft lighting effects with cyan glow */}
      <div className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] bg-cyan-500/[0.025] rounded-full blur-[140px] pointer-events-none" />
      ...
      >
        ...
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-cyan-500/10 bg-cyan-500/[0.02] mb-6 shadow-[0_0_15px_rgba(6,182,212,0.05)]">
        ...
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-light leading-[1.1] tracking-tight mb-6">
          Sua empresa merece um <span className="font-extrabold bg-gradient-to-r from-white to-cyan-300 bg-clip-text text-transparent">visual profissional</span> na internet.
        </h2>
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-4 max-w-xs mx-auto">
          <motion.a 
            ...
            className="group relative px-8 py-4.5 rounded-full bg-cyan-500 text-black font-semibold text-xs uppercase tracking-widest transition-all duration-300 flex items-center justify-center gap-3 shadow-[0_0_30px_rgba(6,182,212,0.3)] hover:bg-cyan-400 border border-cyan-400"
          >
