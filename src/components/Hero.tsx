...
export default function Hero({ onLearnMoreClick }: HeroProps) {
  ...
  return (
    ...
    >
      {/* Background ultra-thin lines layout grid with subtle zinc glow points */}
      ...
      {/* Floating subtle zinc & white gradients */}
      <div className="absolute top-[20%] left-[20%] w-[600px] h-[350px] bg-zinc-500/[0.01] rounded-full blur-[150px] pointer-events-none z-0" />
      <div className="absolute bottom-[15%] right-[10%] w-[500px] h-[500px] bg-zinc-600/[0.01] rounded-full blur-[160px] pointer-events-none z-0" />
      ...
      <header className="relative z-30 border-b border-white/[0.03] bg-[#050507]/40 backdrop-blur-md py-5 px-6 md:px-12">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-[11px] font-mono uppercase tracking-wider text-zinc-400">
            <button onClick={onLearnMoreClick} className="hover:text-white transition-colors cursor-pointer">
              [ O que Fazemos ]
            </button>
            <a href="#why-it-matters" className="hover:text-white transition-colors">
              [ A Diferença ]
            </a>
            <a href="#client-journey" className="hover:text-white transition-colors">
              [ Metodologia ]
            </a>
          </nav>
          ...
          <div>
            <a 
              ...
              className="px-4 py-2 rounded-full border border-white/20 bg-white/5 hover:bg-white text-[11px] text-zinc-300 hover:text-black font-mono uppercase tracking-wider transition-all duration-300 flex items-center gap-2"
            >
      ...
      <div className="flex-grow flex items-center py-12 md:py-20 px-6 md:px-12 relative z-10 max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center w-full">
          ...
          <div className="lg:col-span-6 space-y-8 text-left">
            ...
            >
              {/* Tag / Badge */}
              <motion.div variants={itemVariants} className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm">
              ...
              <motion.h1 variants={itemVariants} className="text-4xl sm:text-5xl md:text-6xl font-display font-light tracking-tight leading-[1.08] text-white">
                Seu negócio merece <span className="font-extrabold bg-gradient-to-r from-white via-zinc-200 to-zinc-400 bg-clip-text text-transparent">mais do que um site comum</span>.
                <span className="block mt-4 text-zinc-400 font-normal text-lg sm:text-xl md:text-2xl leading-relaxed">
                  Criamos sites <span className="text-white border-b border-white/10 pb-0.5 font-medium">rápidos e modernos</span> que passam confiança absoluta e transformam cliques em novos clientes.
                </span>
              </motion.h1>
              ...
              <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2">
                <MagneticButton
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group relative px-8 py-4.5 rounded-full bg-white text-black font-semibold text-xs uppercase tracking-wider hover:bg-zinc-200 transition-all duration-300 flex items-center justify-center gap-3 shadow-[0_10px_35px_rgba(255,255,255,0.02)] cursor-pointer"
                >
                ...
                <MagneticButton 
                  ...
                  className="px-8 py-4.5 rounded-full bg-zinc-950/50 hover:bg-zinc-900 border border-white/5 hover:border-white/20 text-zinc-300 text-xs font-mono uppercase tracking-wider transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer"
                >
                  <span className="flex items-center gap-2">
                    <span>Ver o que fazemos</span>
                    <span className="text-zinc-400 font-mono text-[10px]">// 02</span>
                  </span>
                </MagneticButton>
              </motion.div>
          ...
          <div className="lg:col-span-6 w-full flex items-center justify-center relative">
            ...
            >
              ...
              <motion.div 
                ...
                className="absolute -top-4 -left-4 z-20 px-3.5 py-2 bg-[#08080c]/90 border border-white/10 backdrop-blur-md rounded-2xl flex items-center gap-2.5 shadow-[0_12px_25px_rgba(0,0,0,0.5)]"
              >
                <div className="w-2.5 h-2.5 rounded-full bg-zinc-400 animate-ping" />
                <div>
                  <span className="text-[8px] font-mono text-zinc-500 uppercase block leading-none">Velocidade</span>
                  <span className="text-[11px] font-bold text-zinc-300 font-mono tracking-tight">Abre em 0.3 Segundos</span>
                </div>
              </motion.div>
              ...
              <motion.div 
                ...
                className="absolute -bottom-4 -right-4 z-20 px-3.5 py-2.5 bg-[#08080c]/90 border border-white/10 backdrop-blur-md rounded-2xl flex items-center gap-3 shadow-[0_12px_25px_rgba(0,0,0,0.5)]"
              >
                      ...
                      {activeTab === "speed" && (
                        ...
                        >
                          <div className="grid grid-cols-3 gap-3">
                            <div className="p-3 bg-zinc-950/60 border border-white/10 rounded-xl text-center space-y-1">
                              <span className="text-[8px] font-mono text-zinc-500 uppercase block">Nota Google</span>
                              <span className="text-lg font-bold font-mono text-white text-glow-white">100%</span>
                              <div className="w-full bg-zinc-900 h-1 rounded-full overflow-hidden">
                                <motion.div initial={{ width: 0 }} animate={{ width: "100%" }} transition={{ duration: 0.8 }} className="h-full bg-zinc-400" />
                              </div>
                            </div>
                          ...
                          <div className="bg-zinc-950/40 border border-white/5 rounded-xl p-3 flex items-center justify-between gap-4 mt-2">
                            ...
                            <span className="text-xs font-mono font-bold text-zinc-300 border border-white/10 px-2 py-0.5 rounded-md bg-white/5">
                              VELOZ
                            </span>
                          </div>
                        </motion.div>
                      ...
                      {activeTab === "conversion" && (
                        ...
                        >
                          ...
                          <div className="flex-grow flex items-end justify-between px-2 pt-2 h-[80px]">
                            <svg className="w-full h-full text-zinc-400" viewBox="0 0 100 30" preserveAspectRatio="none">
                              <defs>
                          ...
                          <div className="grid grid-cols-2 gap-2 mt-3">
                            ...
                            <div className="px-3 py-2 bg-white/5 border border-white/10 rounded-xl flex items-center justify-between">
                              <span className="text-[8px] font-mono text-zinc-350 uppercase">Nosso Site</span>
                              <span className="text-[10px] font-bold font-mono text-white">5.4% de Clientes (3x Mais!)</span>
                            </div>
                          </div>
                        </motion.div>
                      )}
                        ...
                        >
                          <div className="bg-zinc-950/80 p-3 rounded-xl border border-white/5 space-y-1 overflow-hidden max-h-[110px]">
                            <div className="flex items-center justify-between text-zinc-600 border-b border-white/[0.03] pb-1 mb-1.5 text-[8px]">
                              ...
                              <span className="text-zinc-500 font-bold">CÓDIGO_LIMPO</span>
                            </div>
                            <p className="text-zinc-500"><span className="text-zinc-400">const</span> criarSite = () =&gt; &#123;</p>
                            <p className="pl-3 text-zinc-400">return (</p>
                            <p className="pl-6 text-zinc-300">&lt;<span className="text-zinc-400">Site</span> velocidade=<span className="text-yellow-400">"Super_Rápido"</span> visual=<span className="text-yellow-400">"Exclusivo"</span>&gt;</p>
                            <p className="pl-9 text-zinc-500">&lt;<span className="text-emerald-400">QualidadeGoogle</span> nota100=<span className="text-zinc-400">&#123;true&#125;</span> /&gt;</p>
                            <p className="pl-6 text-zinc-300">&lt;/<span className="text-zinc-400">Site</span>&gt;</p>
              ...
              <div className="absolute -bottom-10 -left-10 w-44 h-44 border border-white/[0.02] rounded-full blur-[2px] pointer-events-none z-0" />
            </motion.div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <span className="text-xs text-zinc-400 font-light flex items-center gap-2">
              ...
              Desenvolvimento de sites professionals focados no ROI do seu tráfego pago.
            </span>
          </div>
